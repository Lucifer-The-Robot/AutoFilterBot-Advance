...
# Bot Admins
ADMINS = environ.get('ADMINS', '6899946963')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002289453284').split()]
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002386346176').split()]
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002264798778')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://khalnayak0u8y:ARxndIC5HOe2m4sd@cluster0.mtd8b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Ni_Movies')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Ni_Movies')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002330337528")
